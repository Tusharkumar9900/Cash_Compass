...
namespace Expense_Tracker.Controllers
{
    public class DashboardController : Controller
    {
...

        {
            ...
            // Create a CultureInfo object for the Indian culture
          /*  CultureInfo culture = new CultureInfo("en-IN");*/
            ...
            int TotalIncome = SelectedTransactions
                ...
                .Sum(j => j.Amount);
            //added these two line for rupee currency
          ...
          /*  CultureInfo culture = CultureInfo.CreateSpecificCulture("en-IN");*/
            ...
            ViewBag.DoughnutChartData = SelectedTransactions
                ...
                .Select(k => new
                {
                    ...
                    formattedAmount = k.Sum(j => j.Amount).ToString("C0", new CultureInfo("en-IN")),
                })
